...
public final class Regex implements Serializable {
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C00621(input, limit, null));
    }
    ...
    static final class C00621 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00621(CharSequence charSequence, int i, Continuation<? super C00621> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00621 c00621 = Regex.this.new C00621(this.$input, this.$limit, continuation);
            c00621.L$0 = obj;
            return c00621;
        }
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c00621 = this;
                    SequenceScope $this$sequence2 = (SequenceScope) c00621.L$0;
                    matcher = Regex.this.nativePattern.matcher(c00621.$input);
                    if (c00621.$limit == 1 || !matcher.find()) {
                        c00621.label = 1;
                        return $this$sequence2.yield(c00621.$input.toString(), c00621) == coroutine_suspended ? coroutine_suspended : Unit.INSTANCE;
                    }
                    $this$sequence = $this$sequence2;
                    splitCount = 0;
                    nextStart = 0;
                    c00621.L$0 = $this$sequence;
                    c00621.L$1 = matcher;
                    c00621.I$0 = splitCount;
                    c00621.label = 2;
                    if ($this$sequence.yield(c00621.$input.subSequence(nextStart, matcher.start()).toString(), c00621) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c00621.$limit - 1 || !matcher.find()) {
                        charSequence = c00621.$input;
                        c00621.L$0 = null;
                        c00621.L$1 = null;
                        c00621.label = 3;
                        if ($this$sequence.yield(charSequence.subSequence(nextStart, charSequence.length()).toString(), c00621) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                ...
                case 2:
                    c00621 = this;
                    splitCount = c00621.I$0;
                    matcher = (Matcher) c00621.L$1;
                    $this$sequence = (SequenceScope) c00621.L$0;
                    ResultKt.throwOnFailure($result);
                    nextStart = matcher.end();
                    splitCount++;
                    if (splitCount != c00621.$limit - 1) {
    ...
    /* JADX INFO: compiled from: Regex.kt */
    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0006\n\u0002\u0010\u0000\n\u0002\b\u0002\b\u0002\u0018\u0000 \u000e2\u00060\u0001j\u0002`\u0002:\u0001\u000eB\u0015\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\b\u0010\f\u001a\u00020\rH\u0002R\u0011\u0010\u0005\u001a\u00020\u0006¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\tR\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000b¨\u0006\u000f"}, d2 = {"Lkotlin/text/Regex$Serialized;", "Ljava/io/Serializable;", "Lkotlin/io/Serializable;", "pattern", "", DownloaderServiceMarshaller.PARAMS_FLAGS, "", "(Ljava/lang/String;I)V", "getFlags", "()I", "getPattern", "()Ljava/lang/String;", "readResolve", "", "Companion", "kotlin-stdlib"}, k = 1, mv = {1, 9, 0}, xi = 48)
    ...
    /* JADX INFO: compiled from: Regex.kt */
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0004H\u0002J\u000e\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u0007J\u000e\u0010\t\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u0007J\u000e\u0010\n\u001a\u00020\u000b2\u0006\u0010\b\u001a\u00020\u0007¨\u0006\f"}, d2 = {"Lkotlin/text/Regex$Companion;", "", "()V", "ensureUnicodeCase", "", DownloaderServiceMarshaller.PARAMS_FLAGS, "escape", "", "literal", "escapeReplacement", "fromLiteral", "Lkotlin/text/Regex;", "kotlin-stdlib"}, k = 1, mv = {1, 9, 0}, xi = 48)
