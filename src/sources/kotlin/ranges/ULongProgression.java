...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1288getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM253constructorimpl = ((int) ULong.m253constructorimpl(j ^ ULong.m253constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM253constructorimpl2 = (iM253constructorimpl + ((int) ULong.m253constructorimpl(j2 ^ ULong.m253constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + iM253constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sbAppend = sb.append((Object) ULong.m299toStringimpl(this.first)).append("..").append((Object) ULong.m299toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
            sbAppend = sb.append((Object) ULong.m299toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m299toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
