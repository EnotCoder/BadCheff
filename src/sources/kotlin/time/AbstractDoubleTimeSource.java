...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo1395elapsedNowUwyO8pc() {
            return Duration.m1440minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* JADX INFO: renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo1398plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1441plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo1397minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m1410equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m1437isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m1508getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m1440minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
            long startedAtDiff = DurationKt.toDuration(this.startedAt - ((DoubleTimeMark) other).startedAt, this.timeSource.getUnit());
            return Duration.m1410equalsimpl0(startedAtDiff, Duration.m1458unaryMinusUwyO8pc(offsetDiff)) ? Duration.INSTANCE.m1508getZEROUwyO8pc() : Duration.m1441plusLRDsOJo(startedAtDiff, offsetDiff);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1410equalsimpl0(mo1397minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1508getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m1433hashCodeimpl(Duration.m1441plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1454toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }
