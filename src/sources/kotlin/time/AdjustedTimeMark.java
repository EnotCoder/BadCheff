...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1396minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m1542minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo1395elapsedNowUwyO8pc() {
        return Duration.m1440minusLRDsOJo(this.mark.mo1395elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo1398plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1441plusLRDsOJo(this.adjustment, duration), null);
    }
}
