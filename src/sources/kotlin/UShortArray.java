...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static final /* synthetic */ UShortArray m411boximpl(short[] sArr) {
        return new UShortArray(sArr);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static short[] m413constructorimpl(short[] storage) {
        Intrinsics.checkNotNullParameter(storage, "storage");
        return storage;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m416equalsimpl(short[] sArr, Object obj) {
        return (obj instanceof UShortArray) && Intrinsics.areEqual(sArr, ((UShortArray) obj).getStorage());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m417equalsimpl0(short[] sArr, short[] sArr2) {
    ...
    public static int m420hashCodeimpl(short[] sArr) {
        return Arrays.hashCode(sArr);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m424toStringimpl(short[] sArr) {
    ...
    public boolean m425addxj2QHRw(short s) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public final /* bridge */ boolean contains(Object element) {
        if (element instanceof UShort) {
            return m426containsxj2QHRw(((UShort) element).getData());
        }
        return false;
    }
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static short[] m412constructorimpl(int size) {
        return m413constructorimpl(new short[size]);
    }

    /* JADX INFO: renamed from: get-Mh2AYeg, reason: not valid java name */
    public static final short m418getMh2AYeg(short[] arg0, int index) {
        return UShort.m360constructorimpl(arg0[index]);
    }

    /* JADX INFO: renamed from: set-01HTLdE, reason: not valid java name */
    public static final void m423set01HTLdE(short[] arg0, int index, short value) {
        arg0[index] = value;
    }

    /* JADX INFO: renamed from: getSize-impl, reason: not valid java name */
    public static int m419getSizeimpl(short[] arg0) {
        return arg0.length;
    }
    ...
    public static java.util.Iterator<UShort> m422iteratorimpl(short[] arg0) {
    ...
    private static final class Iterator implements java.util.Iterator<UShort>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UShort next() {
            return UShort.m354boximpl(m428nextMh2AYeg());
        }
        ...
        public short m428nextMh2AYeg() {
            ...
            this.index = i + 1;
            return UShort.m360constructorimpl(sArr[i]);
        }
    }

    /* JADX INFO: renamed from: contains-xj2QHRw, reason: not valid java name */
    public boolean m426containsxj2QHRw(short element) {
        return m414containsxj2QHRw(this.storage, element);
    }

    /* JADX INFO: renamed from: contains-xj2QHRw, reason: not valid java name */
    public static boolean m414containsxj2QHRw(short[] arg0, short element) {
    ...
    public static boolean m415containsAllimpl(short[] arg0, Collection<UShort> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    public static boolean m421isEmptyimpl(short[] arg0) {
