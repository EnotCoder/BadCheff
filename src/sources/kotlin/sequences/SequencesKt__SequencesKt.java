...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    mutableList = SequencesKt.toMutableList(c00401.$this_shuffled);
                    break;
                case 1:
                    c00401 = this;
                    mutableList = (List) c00401.L$1;
                    SequenceScope sequenceScope2 = (SequenceScope) c00401.L$0;
                    ResultKt.throwOnFailure(obj);
            ...
            while (!mutableList.isEmpty()) {
                int iNextInt = c00401.$random.nextInt(mutableList.size());
                ...
                c00401.L$1 = mutableList;
                c00401.label = 1;
                if (sequenceScope.yield(objRemoveLast, c00401) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
    ...
    static final class C00351<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00351(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C00351> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00351 c00351 = new C00351(this.$source, this.$transform, this.$iterator, continuation);
            c00351.L$0 = obj;
            return c00351;
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c00351 = this;
                    sequenceScope = (SequenceScope) c00351.L$0;
                    i = 0;
                    it = c00351.$source.iterator();
                    break;
                case 1:
                    c00351 = this;
                    i = c00351.I$0;
                    it = (Iterator) c00351.L$1;
                    sequenceScope = (SequenceScope) c00351.L$0;
                    ResultKt.throwOnFailure(obj);
                    break;
                default:
            ...
            while (it.hasNext()) {
                Object next = it.next();
                Function2<Integer, T, C> function2 = c00351.$transform;
                int i2 = i + 1;
                if (i < 0) {
                    CollectionsKt.throwIndexOverflow();
                }
                Object objInvoke = function2.invoke(Boxing.boxInt(i), (T) next);
                c00351.L$0 = sequenceScope;
                c00351.L$1 = it;
                c00351.I$0 = i2;
                c00351.label = 1;
                if (sequenceScope.yieldAll(c00351.$iterator.invoke((C) objInvoke), c00351) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                i = i2;
            }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt.sequence(new C00351(source, transform, iterator, null));
    }
