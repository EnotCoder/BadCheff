...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    public <T> T[] toArray(T[] array) {
        ...
        int i = this.head;
        if (i < iPositiveMod) {
            ArraysKt.copyInto$default(this.elementData, objArrArrayOfNulls, 0, i, iPositiveMod, 2, (Object) null);
        } else if (!isEmpty()) {
            Object[] objArr = this.elementData;
            ArraysKt.copyInto(objArr, objArrArrayOfNulls, 0, this.head, objArr.length);
            Object[] objArr2 = this.elementData;
            ArraysKt.copyInto(objArr2, objArrArrayOfNulls, objArr2.length - this.head, 0, iPositiveMod);
        }
