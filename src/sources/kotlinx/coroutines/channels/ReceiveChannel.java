...
public interface ReceiveChannel<E> {
    ...
    Object mo1585receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1586tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1586tryReceivePtdJZtk = receiveChannel.mo1586tryReceivePtdJZtk();
            if (ChannelResult.m1602isSuccessimpl(objMo1586tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1598getOrThrowimpl(objMo1586tryReceivePtdJZtk);
            }
            Throwable thM1596exceptionOrNullimpl = ChannelResult.m1596exceptionOrNullimpl(objMo1586tryReceivePtdJZtk);
            if (thM1596exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1596exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            switch (anonymousClass2.label) {
                case 0:
                    ...
                    objMo1585receiveCatchingJP2dKIU = receiveChannel.mo1585receiveCatchingJP2dKIU(anonymousClass2);
                ...
                case 1:
                    ResultKt.throwOnFailure($result);
                    objMo1585receiveCatchingJP2dKIU = ((ChannelResult) $result).getHolder();
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            return ChannelResult.m1597getOrNullimpl(objMo1585receiveCatchingJP2dKIU);
        }
