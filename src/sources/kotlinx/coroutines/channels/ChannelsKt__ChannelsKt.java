...
final /* synthetic */ class ChannelsKt__ChannelsKt {
            ...
            switch (this.label) {
                case 0:
                    ...
                    try {
                        ...
                        r = Result.m79constructorimpl(Unit.INSTANCE);
                        if (Result.m86isSuccessimpl(r)) {
                            objM1605closedJP2dKIU = ChannelResult.INSTANCE.m1607successJP2dKIU(Unit.INSTANCE);
                        } else {
                            objM1605closedJP2dKIU = ChannelResult.INSTANCE.m1605closedJP2dKIU(Result.m82exceptionOrNullimpl(r));
                        }
                        Object r2 = ChannelResult.m1592boximpl(objM1605closedJP2dKIU);
                        return r2;
                    } catch (Throwable th2) {
                        th = th2;
                        Result.Companion companion2 = Result.INSTANCE;
                        r = Result.m79constructorimpl(ResultKt.createFailure(th));
                    }
                    break;
                case 1:
                    try {
                    ...
                    Object r3 = ChannelResult.m1592boximpl(objM1605closedJP2dKIU);
                    return r3;
                default:
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object $this$onSuccess_u2dWpGqRn0$iv = sendChannel.mo1587trySendJP2dKIU(e);
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (!ChannelResult.m1602isSuccessimpl(sendChannel.mo1587trySendJP2dKIU(e))) {
