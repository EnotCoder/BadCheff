...
public interface SendChannel<E> {
    ...
    Object mo1587trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1587trySendJP2dKIU(e);
            if (ChannelResult.m1602isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1596exceptionOrNullimpl = ChannelResult.m1596exceptionOrNullimpl(result);
