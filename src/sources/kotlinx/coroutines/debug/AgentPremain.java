...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM79constructorimpl = Result.m79constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM79constructorimpl = Result.m79constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m85isFailureimpl(objM79constructorimpl) ? null : objM79constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1609installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m1609installSignalHandler$lambda1(Signal it) {
