...
final class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(CancellableContinuation<? super Unit> cont) {
        Object objM1635constructorimpl;
        Object s$iv;
        boolean z;
            ...
            while (true) {
                if (cur$iv$iv.getId() < id$iv || cur$iv$iv.getRemoved()) {
                    ...
                    if (it$iv$iv$iv == ConcurrentLinkedListKt.CLOSED) {
                        objM1635constructorimpl = SegmentOrClosed.m1635constructorimpl(ConcurrentLinkedListKt.CLOSED);
                        break;
                    }
                    ...
                    objM1635constructorimpl = SegmentOrClosed.m1635constructorimpl(cur$iv$iv);
                    curTail = curTail;
                    break;
                }
            }
            s$iv = objM1635constructorimpl;
            if (SegmentOrClosed.m1640isClosedimpl(s$iv)) {
                break;
            }
            Segment to$iv$iv = SegmentOrClosed.m1638getSegmentimpl(s$iv);
            while (true) {
        ...
        SemaphoreSegment segment = (SemaphoreSegment) SegmentOrClosed.m1638getSegmentimpl(s$iv);
