...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM79constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM79constructorimpl = Result.m79constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM79constructorimpl = Result.m79constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m82exceptionOrNullimpl(objM79constructorimpl) == null) {
            obj2 = objM79constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM79constructorimpl2 = Result.m79constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM79constructorimpl2 = Result.m79constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m82exceptionOrNullimpl(objM79constructorimpl2) == null) {
            obj = objM79constructorimpl2;
        }
